...
fs.existsSync(config.app.logDir) || fs.mkdirSync(config.app.logDir);

let transports = [];

if (config.logger.file) {
    let logDir = (config.app.logDir[0] === "." ? path.join(__dirname, config.app.logDir) : config.app.logDir);
